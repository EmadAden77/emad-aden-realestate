...
if footer_index == -1:
    raise SystemExit('Footer element not found')

container_index = html.find('<div class="container">', footer_index)
if container_index == -1:
    raise SystemExit('Footer container not found')
insert_at = container_index + len('<div class="container">')
